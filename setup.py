...
version_dict = {}
with open('./sqlathanor/__version__.py') as version_file:
...
setup(
    ...
    url='https://github.com/insightindustry/sqlathanor',  # Optional
    ...
    project_urls={  # Optional
        'Documentation': 'http://sqlathanor.readthedocs.io/en/latest',
