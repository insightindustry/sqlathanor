...
**SQLAthanor** is meant to be a "beautiful" and "usable" library. That means
...
#. Fork the `Git repository <https://github.com/insightindustry/sqlathanor>`_.
...
Check for open `issues <https://github.com/insightindustry/sqlathanor/issues>`_
...
.. seealso::
  ...
  For more information about the **SQLAthanor** testing approach please
  see: :doc:`Testing SQLAthanor <testing>`
