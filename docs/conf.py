...
htmlhelp_basename = 'SQLAthanordoc'
...
latex_documents = [
    (master_doc, 'SQLAthanor.tex', 'SQLAthanor Documentation',
...
man_pages = [
    (master_doc, 'sqlathanor', 'SQLAthanor Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'SQLAthanor', 'SQLAthanor Documentation',
     author, 'SQLAthanor', 'One line description of project.',
     'Miscellaneous'),
]
